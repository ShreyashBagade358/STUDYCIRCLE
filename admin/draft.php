...
<section class="playlists">
    ...
    <div class="box-container">
        ...
        <?php
        $select_playlist = $conn->prepare("SELECT * FROM `playlist` WHERE tutor_id = ? AND status = 'deactive' ORDER BY date DESC");
        ...
        if($select_playlist->rowCount() > 0){
            ...
            echo '<p class="empty">No inactive playlists added yet!</p>';
        }
        ?>
